...
var FileTabs = function FileTabs(_ref) {
  ...
  return /*#__PURE__*/React.createElement(_themes.Tabs.Root, {
    className: _stylesModule["default"].Root,
    value: selectedSnippetIndex,
    onValueChange: handleTabChange
  }, /*#__PURE__*/React.createElement(_themes.Tabs.List, {
    className: _stylesModule["default"].List
  }, snippets.map(function (snippet, index) {
    return snippet.file_name ? /*#__PURE__*/React.createElement(_themes.Tabs.Trigger, {
      className: _stylesModule["default"].Trigger,
      key: snippet.id,
      value: index
    }, /*#__PURE__*/React.createElement(_themes.Text, {
      style: {
        color: "white",
        cursor: "pointer"
      }
    ...
    return /*#__PURE__*/React.createElement(_themes.Tabs.Content, {
      className: _stylesModule["default"].Content,
      key: snippet.id,
      value: index
    }, /*#__PURE__*/React.createElement(_codeSnippets.CodeSnippets, {
      code: snippet.code,
